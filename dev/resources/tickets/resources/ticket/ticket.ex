defmodule Demo.Tickets.Ticket do
  ...
  admin do
    ...
    format_fields description: {AdminFieldFormats, :format_field, [:description]}
  ...
  actions do
    ...
    create :open do
      ...
      change(
        manage_relationship(:organization,
          on_no_match: :create,
          on_lookup: :relate,
          on_match: :ignore
        )
      ...
      change(
        manage_relationship(:tickets, :source_links,
          on_lookup: {:relate_and_update, :create, :read, :all}
        )
      )
    end
  ...
  attributes do
    ...
    attribute :metadata, {:array, Demo.Tickets.Ticket.Types.Metadata} do
      public?(true)
    end
